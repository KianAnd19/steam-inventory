  ...
  return (
      <div className="p-4 bg-gray-900 min-h-screen">
        ...
        <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-5 gap-4 mt-6 w-full grid-flow-row-dense'>
          ...
          <div className='row-span-1 col-span-1 bg-gray-800 rounded-3xl p-2 items-center'>
            <h1 className='text-gray-100 text-xl text-center'>Please move all your items out of storage containers for an accurate evaluation.</h1>
          </div>
          ...
          <div className='col-span-2 bg-gray-800 rounded-3xl p-2 w-full h-full'>
          ...
          <div className='row-span-2 col-span-1 bg-gray-800 rounded-3xl p-2 w-full h-full'>
